...
public class Spam_fragment extends Fragment {
    ...
    ArrayList<String> smsMessagesList3 = new ArrayList<>();
    ListView listViewAll3;
    ...
    public Spam_fragment(){}
    public Spam_fragment(Context context) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Spam");
        listViewAll3 = (ListView) rootView.findViewById(R.id.listViewspam);
        arrayAdapter3 = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1, smsMessagesList3);
        listViewAll3.setAdapter(arrayAdapter3);
        refresh();
        return rootView;
    }
    public void refresh()
